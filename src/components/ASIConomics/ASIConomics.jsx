...
const ASIConomics = () => {
  return (
    <section
      id="asiconomics"
      className="container  pb-32  px-10 grid grid-cols-1 lg:grid-cols-2"
    >
      <div>
      ...
      <div className="h-[360px] relative">
        <div className="">
          ...
          <div className="absolute top-[105%] lg:top-[36%] right-[10%] lg:right-[0]">
            <div className="card-shadow max-h-[110px] rounded-xl bg-white p-5 w-[260px]">
              <h4 className="text-[14px] text-skin-dark ">
                ...
                will be used to buy new and maintain existing hardware, incl.
                cage rental.
              </h4>
            </div>
          </div>
          <div className="absolute top-[36%] left-[12%] xl:left-0">
            <div className="card-shadow max-h-[110px] rounded-xl bg-white p-5 w-[260px]">
              <h4 className="text-[14px] text-skin-dark ">
          ...
          <div className="absolute top-[0%] left-[13%] xl:left-[33%]  card-shadow max-h-[110px] rounded-xl bg-white p-5 w-[260px]">
            <h4 className="text-[14px] text-skin-dark ">
          ...
          <div className="card-shadow absolute left-[13%] xl:left-[33%]  bottom-[0%] max-h-[110px] rounded-xl bg-white p-5 w-[260px]">
            <h4 className="text-[14px] text-skin-dark ">
